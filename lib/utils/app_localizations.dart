...
class AppLocalizations {
  ...
  static Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'numberOfVolleys': 'Number of Ends',
      ...
      'oddVolleyDivisive': 'Odd End - Divisive',
      'evenVolleyMultiplier': 'Even End - Multiplier',
    ...
    'it': {
      ...
      'numberOfVolleys': 'Numero di Tiri',
      ...
      'oddVolleyDivisive': 'Tiro Dispari - Divisivo',
      'evenVolleyMultiplier': 'Tiro Pari - Moltiplicatore',
